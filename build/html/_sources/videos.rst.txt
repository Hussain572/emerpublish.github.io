...
.. raw:: html
   ...
   <iframe width="560" height="315" src="https://www.youtube.com/embed/BMAmLXDYW2k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
3. In the ribbon, click Send to **RMS**. The **Transfer data to Roxar RMS** dialog appears. Notice the two columns, left for Petrel and right for RMS data.
   ...
   .. warning:: *Coordinate systems and units used in Petrel are inherited by the RMS project if a new project is created.* 
...
.. admonition:: Remember! 
   ...
   *Coordinate systems and units used in Petrel are inherited by the RMS project if a new project is created.*  
